...
# 🖼️ My Personal Wallpaper Collection

**A carefully curated collection of high-quality wallpapers, organized by aesthetic and mood.**

![Total](https://img.shields.io/badge/Total_Wallpapers-2200+-8b5cf6?style=for-the-badge&labelColor=1a1a2e)
![Categories](https://img.shields.io/badge/Categories-10-06d6a0?style=for-the-badge&labelColor=1a1a2e)
![Formats](https://img.shields.io/badge/Formats-JPG_·_PNG_·_WEBP_·_GIF_·_MP4-f72585?style=for-the-badge&labelColor=1a1a2e)
...
> Seasonal themes, traditional art, textures, and uncategorized gems.

**Subcategories:** `Halloween` · `Painting` · `Paper` · `Spam` · `Unsorted`
...
│
├── 🔷 Abstract & Minimalist/
│   ├── Abstract/          # Bold colors, fluid shapes
│   ├── Centered/          # Subject-centered compositions
│   ├── Devicons/          # Developer & tech iconography
│   ├── Geometry/          # Geometric patterns & tessellations
│   ├── Lightbulb/         # Light-themed minimal art
│   ├── Logo/              # Iconic logo wallpapers
│   ├── Minimal/           # Less is more
│   ├── Monochrome/        # Black, white & grayscale
│   ├── Poly/              # Low-poly style artwork
│   └── Tile/              # Repeating tileable patterns
│
├── 🎞️ Animated/              # Live video wallpapers (.mp4)
│
├── ⛩️ Anime & Manga/
│   ├── Anime/             # General anime artwork
│   ├── Boccha/            # Bocchi the Rock! fan art
│   ├── Evangelion/        # Neon Genesis Evangelion
│   ├── Girl/              # Anime girl illustrations
│   └── Manga/             # Manga panel artwork
│
├── 🐱 Catppuccin/
│   ├── Dithered/          # Dithered texture effects
│   ├── Flatppuccin/       # Flat design style
│   ├── Gradients/         # Smooth color gradients
│   ├── Landscapes/        # Nature in Catppuccin tones
│   ├── Mandelbrot/        # Fractal art
│   ├── Minimalistic/      # Clean & simple
│   ├── Misc/              # Other Catppuccin wallpapers
│   ├── Mocha/             # Catppuccin Mocha flavor
│   ├── OS/                # OS-themed (Linux, etc.)
│   ├── Patterns/          # Repeating patterns
│   ├── Solids/            # Solid color backgrounds
│   └── Waves/             # Wave & flow designs
│
├── 🎨 Color Themes/
│   ├── Basalt/            # Dark volcanic tones
│   ├── Gruvbox/           # Gruvbox retro color scheme
│   ├── Nord/              # Arctic, north-bluish palette
│   ├── Radium/            # Glowing neon-green theme
│   └── Solarized/         # Solarized light & dark
│
├── 💻 Digital Art & Cyberpunk/
│   ├── Apeiros/           # Infinite loop digital art
│   ├── Apocalypse/        # Post-apocalyptic scenes
│   ├── Digital/           # General digital illustrations
│   ├── Dreamcore/         # Surreal dreamlike imagery
│   ├── Jackb/             # Artist: JackB collection
│   ├── M-26.jp/           # Artist: M-26.jp collection
│   ├── Outrun/            # 80s synthwave aesthetics
│   ├── Pixel/             # Pixel art & 8-bit style
│   ├── Retro/             # Vintage & retro-tech
│   ├── Stalenhag/         # Simon Stålenhag-inspired art
│   └── Weirdcore/         # Unsettling surreal imagery
│
├── 🌌 Mood & Atmosphere/
│   ├── Calm/              # Peaceful & serene
│   ├── Chillop/           # Chill lo-fi vibes
│   └── Cold/              # Winter & icy atmospheres
│
├── 🌲 Nature & Landscapes/
│   ├── Aerial/            # Drone & bird's eye views
│   ├── Cherry/            # Cherry blossoms & sakura
│   ├── Fauna/             # Wildlife & animals
│   ├── Flowers/           # Floral close-ups & gardens
│   ├── Fogsmoke/          # Misty & foggy scenes
│   ├── Mountain/          # Peaks, ridges & alpine
│   ├── Nature/            # General nature photography
│   └── Wave/              # Ocean waves & water
│
├── 📁 Other/
│   ├── Halloween/         # Spooky seasonal wallpapers
│   ├── Painting/          # Traditional painted artwork
│   ├── Paper/             # Paper & texture backgrounds
│   ├── Spam/              # Miscellaneous finds
│   └── Unsorted/          # Awaiting categorization
│
└── 🏛️ Urban & Architecture/
    ├── Architecture/      # Stunning buildings & structures
    ├── Decay/             # Urban decay & abandoned places
    ├── Industrial/        # Factories, machines & grit
...
This is a personal collection assembled from various sources across the internet. All wallpapers remain the property of their respective creators. This repository is intended for personal use only.

If you are the original creator of any wallpaper included here and would like it removed, please open an issue.
